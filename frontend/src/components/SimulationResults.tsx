    ...
    if (!simulation) {
        return (
            <div className="bg-white/5 rounded-2xl p-5 border border-white/5 flex items-center justify-center opacity-40">
                <span className="text-[10px] font-mono tracking-widest uppercase">Awaiting Monte Carlo Data...</span>
            </div>
        );
    }
        ...
        <div className="bg-white/5 rounded-2xl p-5 border border-white/5 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div className={`text-2xl font-black font-tech ${simulation.winRate >= 58 ? 'text-emerald-400' : 'text-red-400'}`}>
            ...
            <div className="mt-4 pt-4 border-t border-white/5 flex justify-between items-center">
                <span className="text-[8px] text-gray-600 font-mono uppercase">Iterations: {simulation.iterations}k</span>
                <span className="text-[8px] text-gray-600 font-mono uppercase">Variance: {simulation.variance}%</span>
            </div>
        </div>
    );
};
