...
export const setupAPIRoutes = (sseManager: SSEManager, stateManager: StateManager, engineBridge: EngineBridge) => {
    ...
    router.post('/run', async (req: Request, res: Response) => {
        ...
        sseManager.broadcast({ type: 'STATE', state: { isProcessing: true, cycleCount: state.cycleCount + 1 } });

        console.log(`[BRIDGE] Triggering Python Engine (Cycle ${state.cycleCount + 1}, Paper: ${isPaperTrading})...`);
